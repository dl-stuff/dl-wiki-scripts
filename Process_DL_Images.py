...
CATEGORY_REGEX = {
    ...
    re.compile(r'images/outgame/shop/top/shopspecialpacknotice'): '_Shop_Banner_Images (May be Dream_Summon_Banner_Images)',
    ...
    re.compile(r'images/icon/eventthumbnail/(\d+)'): '_Memory_Icons',
    ...
    re.compile(r'images/icon/dmode/l/(\d+)'): 'Kaleidoscape_Item_Icons',
    re.compile(r'images/icon/dmodestorycellbg/(\d+)'): 'Kaleidoscape_Story_Headers',
    re.compile(r'images/icon/talisman/l/(\d+)'): 'Portrait_Wyrmprint_Icons',
    re.compile(r'images/icon/uniquetransform/'): 'Unique_Transformation_Icons',
...
CATEGORY_NAME_FORMATS = {
    ...
    'Enemy_Score_Icons': (lambda x: 'EnemyIcon_{}'.format(x)),
    'Kaleidoscape_Item_Icons': (lambda x: 'KaleidoscapeItem_{}'.format(x)),
    'Kaleidoscape_Story_Headers': (lambda x: 'KaleidoscapeStoryHeader_{}'.format(x)),
    'Portrait_Wyrmprint_Icons': (lambda x: 'PortraitWyrmprintIcon_{}'.format(x)),
    '_Memory_Icons': (lambda x: 'Memory_Icon_{}'.format(x)),
