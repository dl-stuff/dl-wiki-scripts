...
def read_manifest(manifest, filter_str):
    manifest_set = set()
...
async def main(manifest, filter_str, old_manifest=None):
    manifest_set = read_manifest(manifest, filter_str)
    if old_manifest is not None:
        manifest_old = read_manifest(old_manifest, filter_str)
...
if __name__ == '__main__':
    ...
    loop.run_until_complete(main(args.m, args.f, args.o))